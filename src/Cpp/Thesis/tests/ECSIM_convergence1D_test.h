#ifndef ECSIM_CONVERGENCE_TEST_1D_H
#define ECSIM_CONVERGENCE_TEST_1D_H
...
int ECSIM_convergence1D_test(int argc, char* argv[]) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        if (arg == "-dt" && i + 1 < argc) {
            ...
            std::cerr << "Usage: " << argv[0] << " -n <number of threads> -t <time interval [0,t]> -dt <coarse timestep> -tr <parareal tolerance>" << std::endl;
            return 1;
        }
    }
    T = T == 0 ? 1 : T;
